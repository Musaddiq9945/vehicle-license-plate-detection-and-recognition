...
# Inference 🚀
The trained YOLOv11 model was downloaded from Google Colaboratory and can be used to detect and save licence plate images offline, locally and registration number can be read from the saved license plate images using EasyOCR
